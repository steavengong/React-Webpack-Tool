    ...
    return (
      <div className={this.props.isShow?'page_part photo_part animated fadeIn':'page_part photo_part hidden'}>
        <img src={this.props.jsBridge?simpleTouchText:longTouchText}
             className={this.props.fileResult && (typeof (this.props.fileResult) === 'string') && this.props.isSelf?
              "img_auto_height img_long_touch animated infinite flash flash_star":
              "img_auto_height img_long_touch hidden"}/>
        <img src={finger}
             className={this.props.fileResult && (typeof (this.props.fileResult) === 'string')  && this.props.isSelf?
             "img_auto_height img_normal_finger animated infinite flash flash_star":
             "img_auto_height img_normal_finger hidden"}/>
        ...
        <img src={invite}
             className={this.props.needJoin||!(this.props.hasJoin&&this.props.isSelf)?
             "img_auto_height img_invite_friend hidden":"img_auto_height img_invite_friend"}
             onClick={this.showShareLayer}/>
        <img src={enjoyGift}
             className={this.props.needJoin||!(this.props.hasJoin&&this.props.isSelf)?
             "img_auto_height img_enjoy_gift hidden":"img_auto_height img_enjoy_gift"}
             onClick={this.showGiftLayer}/>
        <img src={enjoy} className={this.props.needJoin||(this.props.hasJoin&&this.props.isSelf)?
            "img_auto_height img_enjoy hidden":"img_auto_height img_enjoy"}
             onClick={this.redirect}/>
        <img src={rule} className={this.props.needJoin||(this.props.hasJoin&&this.props.isSelf)?
            "img_auto_height img_rule hidden":"img_auto_height img_rule"}
